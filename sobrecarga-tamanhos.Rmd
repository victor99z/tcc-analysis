...
summary(sexo1$Latency)
round(sd(sexo1$Latency), 2)
quantile(sexo1$Latency, 0.99)

summary(sexo2$Latency)
round(sd(sexo2$Latency), 2)
quantile(sexo2$Latency, 0.99)

summary(sexo3$Latency)
round(sd(sexo3$Latency), 2)
quantile(sexo3$Latency, 0.99)
